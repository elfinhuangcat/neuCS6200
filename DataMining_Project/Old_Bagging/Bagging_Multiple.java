...
//        trainBagging(args[1],path, true);
     ...
     * @throws Exception
     */
    public static void testBagging(String testFile, String path) throws Exception {
    ...
    private static Result startTesting(Instances data, String path) throws Exception {
        ...
        String log = String.format("Total training instances: %d\n", data.numInstances());
     ...
     * @throws Exception
     */
    public static void trainBagging(String trainFile, String path, boolean isCrossValidation) throws Exception {
